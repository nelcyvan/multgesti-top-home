...
interface AguardandoPagamentoModalProps {
  isOpen: boolean;
  onClose: () => void;
  dadosLinha: LancamentosApagarRow | null;
}

const AguardandoPagamentoModal: React.FC<AguardandoPagamentoModalProps> = ({ isOpen, onClose, dadosLinha }) => {
        ...
        <div className="modal-dialog modal-md modal-dialog-centered" role="document" style={{ maxWidth: "40vw" }}>
          <div className="modal-content">
            <div className="modal-header">
              <h5 className="modal-title" style={{ fontSize: "0.9rem" }}>Aguardando Pagamento</h5>
...
export default AguardandoPagamentoModal;