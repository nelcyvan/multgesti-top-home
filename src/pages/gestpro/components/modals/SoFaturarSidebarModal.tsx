...
import SoFaturarStatus15Modal from "./SoFaturarStatus15Modal";
...
const SoFaturarSidebarModal: React.FC<Props> = ({ onClose }) => {
...
export default SoFaturarSidebarModal;
