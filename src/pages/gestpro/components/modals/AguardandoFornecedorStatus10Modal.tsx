...
const AguardandoFornecedorStatus10Modal: React.FC<Props> = ({ pedidos, onClose, onTriagem, PedidoCardComponent }) => {
  return (
    <div className="modal show d-block" tabIndex={-1} style={{ backgroundColor: "rgba(0,0,0,0.5)", zIndex: 1060 }}>
      <div className="modal-dialog modal-fullscreen">
        <div className="modal-content">
          <div className="modal-header bg-info text-dark">
            <h5 className="modal-title">Pedidos Aguardando Fornecedor (Status 10)</h5>
...
export default AguardandoFornecedorStatus10Modal;
