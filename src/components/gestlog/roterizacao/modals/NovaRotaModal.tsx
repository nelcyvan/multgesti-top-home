...
export interface NovaRotaModalProps {
  open: boolean;
...
const NovaRotaModal: React.FC<NovaRotaModalProps> = ({
  open,
  setOpen,
  submitting,
  msg,
      ...
      <div style={{ position: 'absolute', inset: '8px', display: 'flex' }}>
        <div className="card shadow" style={{ border: '1px solid rgba(0,0,0,0.175)', width: '100%', overflow: 'hidden' }}>
          <div className="card-header py-1 d-flex justify-content-between align-items-center" style={{ fontSize: '0.85rem' }}>
            ...
            <button
              type="button"
              className="btn btn-outline-secondary btn-sm py-0 px-1 d-inline-flex align-items-center justify-content-center"
              onClick={() => {
                setMsg(null);
                setOpen(false);
              }}
